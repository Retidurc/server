...
class Server extends ServerContainer implements IServerContainer {
	...
	public function __construct($webRoot, \OC\Config $config) {
		...
		$this->registerAlias(\OCP\Files\AppData\IFactory::class, \OC\Files\AppData\Factory::class);
	 ...
	 * @deprecated 20.0.0 Use get(\OCP\Files\AppData\IFactory::class)->get($app) instead
	 */
